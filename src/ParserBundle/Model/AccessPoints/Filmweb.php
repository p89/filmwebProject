...
class Filmweb
{
    ...
    {
        if(! isset(\AccessPoints\Filmweb::$_instance[$name]))
        {
            \AccessPoints\Filmweb::$_instance[$name] = new \AccessPoints\Filmweb;
        }
        
        return \AccessPoints\Filmweb::$_instance[$name];
    }
    
    public function __construct()
    {
        // Automatyczne ładowanie wymaganych klas
        spl_autoload_register('\AccessPoints\Filmweb::loader');
    }
   ...
   */
    ...
    {
        $class = '\AccessPoints\\API\\Methods\\'.$method;
    ...
    */
    public static function loader($class)
    {
        ...
        if(file_exists($class))
            ...
            throw new \Exception('Could not find class: Filmweb_'.basename($class).$class);
    }
}